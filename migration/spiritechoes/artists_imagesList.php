...
<table width="100%" border=0 cellpadding=1 cellspacing=0>
  ...
  <tr> 
    ...
    <tr>
	<td align="left" colspan="4" ><font color="#009999" size="-1" >*Indicates that the artist will 
	be demonstrating their media during the two day festival. Please check festival 
	boards for time. </font>
	</td>
	</tr>
	<tr>
	
<td align="left" colspan="4" > Click on the Exhibitor's name for a sample of their 
work </td>
	</tr>
<?php
...
if (file_exists($image)) { 
   ...
   echo "$row[0]</a></td><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td>";
} else {
   echo "<td>$row[0]</td><td>$image</td><td>$row[2]</td><td>$row[3]</td>";
}
echo "</tr>\n";
}
