...
<table width="100%" border=0 cellpadding=1 cellspacing=0>
  ...
  <tr> 
    ...
    <tr>
	<td>&nbsp;</td>
	<td align="center" colspan="3"><font size="-1">*Indicates that the artist 
      will be demonstrating their media at the front of the Crockett Center during 
      the two day festival. Please check festival boards for time. </font> </td>
	  </tr>
<?php

$filename = "artistlist.txt"; //here's the filename
